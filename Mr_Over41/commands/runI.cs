        ...
        public bool Execute(ArraySegment<string> arguments, ICommandSender sender, out string response) {
            ...
            foreach (Player player in Player.List) {
                ...
                if (player.Role == RoleTypeId.Scientist) {
                    ...
                    switch (API._System.random.Next(0, 3)) {
                        case 0:
                    ...
                    player.Teleport(new Vector3(204.526f, 1019, -128) + new Vector3(API._System.random.Next(0, 5), 0, API._System.random.Next(-5, 0)));
                    if (API._System.random.Next(0, 2) == 0) { 
